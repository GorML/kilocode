...
// The preload disables the file watcher suite-wide; this file tests it, so opt back in.
...
// The file watcher is unreliable on Windows CI (the suite historically runs
// with it disabled there), so this test only runs on unix.
