...
process.env["KILO_EXPERIMENTAL_DISABLE_FILEWATCHER"] ??= "true" // kilocode_change - instance watcher warm-up churns real fs watchers on short-lived tmpdirs; tests that need the watcher opt back in
